...
const reviews = [
  { name: "Rajesh Kumar", occupation: "Business Owner", city: "Mumbai", country: "IN", rating: 4.8, source: "google", hasVideo: true, review: "SERNET has been instrumental in growing my portfolio. Their personalized approach and deep market knowledge have helped me achieve my financial goals.", date: "Jan 2025" },
  { name: "Priya Sharma", occupation: "IT Professional", city: "Delhi", country: "IN", rating: 5.0, source: "facebook", hasVideo: false, review: "The team at SERNET is incredibly professional and knowledgeable. They've been managing my family's investments for over 10 years with excellent returns.", date: "Dec 2024" },
  { name: "Anand Mehta", occupation: "Chartered Accountant", city: "Bangalore", country: "IN", rating: 4.9, source: "google", hasVideo: true, review: "Exceptional service and transparent communication. I highly recommend SERNET for anyone looking for reliable investment advisory services.", date: "Nov 2024" },
  { name: "Sunita Patel", occupation: "Homemaker & Investor", city: "Ahmedabad", country: "IN", rating: 5.0, source: "instagram", hasVideo: false, review: "From insurance planning to equity investments, SERNET has provided comprehensive solutions for all my financial needs. Truly a one-stop destination.", date: "Oct 2024" },
  { name: "Vikram Singh", occupation: "Retired Army Officer", city: "Jaipur", country: "IN", rating: 4.7, source: "mouthshut", hasVideo: false, review: "Switched from a big-name broker and couldn't be happier. Personal attention and zero hidden charges make SERNET stand out from the crowd.", date: "Sep 2024" },
  { name: "Meera Nair", occupation: "Doctor", city: "Kochi", country: "IN", rating: 4.9, source: "google", hasVideo: true, review: "Their research reports are top-notch. I've made informed decisions that consistently outperform the market benchmarks.", date: "Aug 2024" },
  { name: "Deepak Verma", occupation: "Software Engineer", city: "Lucknow", country: "IN", rating: 4.8, source: "google", hasVideo: false, review: "The onboarding process was seamless and the support team is always just a call away. Great experience overall with SERNET.", date: "Jul 2024" },
  { name: "Kavita Joshi", occupation: "School Principal", city: "Pune", country: "IN", rating: 5.0, source: "facebook", hasVideo: true, review: "I trust SERNET with my retirement planning. Their long-term vision and disciplined approach give me complete peace of mind.", date: "Jun 2024" },
];
              ...
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex items-center gap-0.5">
                    {[...Array(5)].map((_, i) => (
                      <Star key={i} className={`w-3.5 h-3.5 ${i < Math.floor(review.rating) ? 'fill-[hsl(var(--sernet-yellow))] text-[hsl(var(--sernet-yellow))]' : i < review.rating ? 'fill-[hsl(var(--sernet-yellow))]/50 text-[hsl(var(--sernet-yellow))]' : 'text-muted-foreground/30'}`} />
                    ))}
                  </div>
                </div>

    ...
    <section className="section-padding bg-background">
      <div className="container-zerodha">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-stretch">
          ...
          >
            <img src={sernetShowcase} alt="SERNET financial education platform – courses, coaching and financial literacy programs for investors" className="rounded-xl w-full max-w-[520px] max-h-[400px] object-contain dark:bg-white dark:p-3" loading="lazy" width={2000} height={2000} />
          </motion.div>
        </div>
      </div>
    </section>

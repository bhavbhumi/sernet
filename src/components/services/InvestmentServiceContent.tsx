    ...
    <section className="section-padding bg-background">
      <div className="container-sernet">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-stretch">
          ...
          >
            <img src={choicefinxShowcase} alt="TickFunds mutual fund investment platform – SIP, lumpsum and goal-based portfolio management on desktop and mobile" className="rounded-xl w-full max-w-[520px] max-h-[400px] object-contain dark:bg-white dark:p-3" loading="lazy" width={1280} height={720} />
          </motion.div>
        </div>
      </div>
    </section>
      ...
      <div className="container-sernet">
        ...
        >
          <div className="flex-1 text-center lg:text-left">
            ...
            <a
              href={TICKFUNDS_LINKS.START_INVESTING}
              target="_blank"

    ...
    <section className="section-padding bg-background">
      <div className="container-zerodha">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-stretch">
          ...
          >
            <img src={choicefinxShowcase} alt="Tushil insurance platform on desktop, tablet and mobile" className="rounded-xl w-full max-w-[520px] max-h-[400px] object-contain dark:bg-white dark:p-3" />
          </motion.div>
        </div>
      </div>
    </section>

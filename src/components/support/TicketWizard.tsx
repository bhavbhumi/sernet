...
interface TicketWizardProps {
  /** If true, shows the H1 heading on step 1 */
  showHeading?: boolean;
}
...
export function TicketWizard({ showHeading = true }: TicketWizardProps) {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      {step === 1 && (
        <div>
          {showHeading && <h1 className="text-2xl font-bold text-foreground mb-2">Raise a Support Ticket</h1>}
          <p className="text-muted-foreground mb-6">Which product is this regarding?</p>

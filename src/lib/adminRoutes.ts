...
export const ADMIN_ROUTES = {
  ...
  hr: {
    ...
    expenseClaims: '/admin/hr/expenses',
    documentVault: '/admin/hr/documents',
    loans: '/admin/hr/loans',
    incrementLetters: '/admin/hr/increment-letters',
    employeeExit: '/admin/hr/exit',
    importSpine: '/admin/hr/import-spine',
  },

...
const Services = () => {
  ...
  return (
    <Layout>
      <SEOHead
        title="Financial Services – Trading, Investment & Insurance"
        description="Explore SERNET's full suite of financial services including trading, mutual funds, insurance, estate planning and credit counselling."
        path="/services"
      />
      <PageHero

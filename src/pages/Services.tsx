  ...
  return (
    <Layout>
      <SEOHead
        ...
        description="Trading, Investment, Insurance, Education, Estate Planning and Credit Counselling services by SERNET with transparent pricing and dedicated support."
        path="/services"
      />
      <PageHero

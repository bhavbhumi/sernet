      ...
      <div className="container-zerodha">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.15 }} className="flex items-center justify-center">
            <img src={choicefinxShowcase} alt="Tushil insurance comparison platform – life, health, motor and travel insurance solutions for families" width={1280} height={720} className="rounded-xl w-full max-w-[540px] object-contain dark:bg-white dark:p-3" />
          </motion.div>
        </div>
      </div>
    </section>

        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <div className="flex flex-wrap items-center gap-3 mb-10">
              <a href={TICKFUNDS_LINKS.APP_STORE} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-lg bg-primary text-primary-foreground text-sm font-medium hover:bg-primary/90 transition-colors">
              ...
              <a href={TICKFUNDS_LINKS.PLAY_STORE} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-lg bg-primary text-primary-foreground text-sm font-medium hover:bg-primary/90 transition-colors">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.15 }} className="flex items-center justify-center">
            <img src={choicefinxShowcase} alt="TickFunds mutual fund investment platform – SIP calculator, goal-based planning and retirement wealth management" width={1280} height={720} className="rounded-xl w-full max-w-[540px] object-contain dark:bg-white dark:p-3" />
          </motion.div>
        </div>
      </div>
    </section>
      ...
      <div className="container-zerodha">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="rounded-2xl border border-primary/10 p-8 md:p-12 lg:p-16 flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
          <div className="flex-1 text-center lg:text-left">
            ...
            <a href={TICKFUNDS_LINKS.START_INVESTING} target="_blank" rel="noopener noreferrer" className="btn-primary">Get Your Free Checkup <ArrowRight className="w-4 h-4 ml-2" /></a>
          </div>
    ...
    <section className="section-padding bg-section-alt">
      <div className="container-zerodha">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.4 }} className="text-center mt-12">
          <a href={TICKFUNDS_LINKS.START_INVESTING} target="_blank" rel="noopener noreferrer" className="btn-primary">Start Investing Today <ArrowRight className="w-4 h-4 ml-2" /></a>
        </motion.div>
      </div>
    </section>
    ...
    <section className="py-16 md:py-20 bg-section-alt">
      <div className="container-zerodha text-center">
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }} className="flex flex-wrap justify-center gap-4">
          <a href={TICKFUNDS_LINKS.START_INVESTING} target="_blank" rel="noopener noreferrer" className="btn-primary">Open Free Account <ArrowRight className="w-4 h-4 ml-2" /></a>

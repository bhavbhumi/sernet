...
function PayslipPreview({ row, month, year, workingDays }: { row: EmployeeCalc; month: number; year: number; workingDays: number }) {
  const earnings = [
  ...
  return (
    <>
      ...
      <div data-payslip className="space-y-4 text-sm">
        ...
        <Button data-print-hide variant="outline" className="w-full" onClick={handlePrint}>
